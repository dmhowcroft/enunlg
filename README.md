...
We originally managed dependencies and virtual environments using [`poetry`](https://python-poetry.org/) and tested using [`pytest`](https://pytest.org/).

The instructions below reflect this, but going forward we will switch to using [`uv`](https://docs.astral.sh/uv/)
...
In 2025 we ran this training in 468 minutes in Python 3.12 on an i7-13800H laptop CPU with a mix of 'performance' and 'balanced' performance settings selected on a Zbook running Ubuntu 24.04.
